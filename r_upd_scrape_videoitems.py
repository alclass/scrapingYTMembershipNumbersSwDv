...
Optional parameters:
  1) if no parameters are used, both ini and fim would be set to today's date and
     processing will occur only for today's date;
...
Examples:
  ...
  will consider the 8-day range with 2020-05-23 and fim=2020-05-30, ie 2020-05-23, 2020-05-24, 2020-05-25 and so on up
      to 2020-05-30;
